...
(function () {
    ...
    return e("div", { className: "lab" },
      ...
      e("header", { className: "lab-top" },
        ...
        e("div", { className: "top-actions" },
          e("a", { className: "app-link", href: "../Form Creator.dc.html", title: "Go to the Google Form Creator" }, "📋 Form Creator"),
          window.__sflBridge ? null : e("a", { className: "app-link", href: "../../Worksheet Compiler.dc.html", title: "Go to the Science Worksheet Compiler" }, "📚 Compiler"),
      ...
      e("div", { className: "lab-body" + (sideOpen ? "" : " noside") },
        ...
        e("aside", { className: "lab-side" },
          e(Panel, { className: "sfl-panel", title: "Class Roster", accent: "yellow" },
          ...
          e(Panel, { className: "sfl-panel", title: "How it works", accent: "blue", style: { marginTop: 14 } },
            e("ol", { className: "how" },
          ...
          (missing && missing.length) ? e(Panel, { className: "sfl-panel", title: "Missing Submissions", accent: "red", style: { marginTop: 14 } },
          ...
          ) : e(Panel, { className: "sfl-panel", title: "Missing Submissions", accent: hasRoster ? "green" : "blue", style: { marginTop: 14 } },
            hasRoster
  ...
  function SetupModal({ mcqKey, openDefs, students, meta, onClose, onApply }) {
    ...
    async function runImport() {
      ...
      try {
        ...
        A.rememberMcqStems((scan && scan.cols) || []);
    ...
    return e(Overlay, { onClose },
      e(Panel, { className: "sfl-panel", title: "Setup — Import or Paste Your Worksheet", accent: "green", solid: true, style: { width: "min(900px, 94vw)", maxHeight: "88vh", overflow: "auto" } },
  ...
  function ExportModal({ results, students, meta, onClose }) {
    ...
    return e(Overlay, { onClose },
      e(Panel, { className: "sfl-panel", title: "Export to Google Doc", accent: "green", solid: true, style: { width: "min(860px, 94vw)", maxHeight: "88vh", overflow: "auto" } },
        ordered.length === 0
  ...
  function MistakesModal({ students, mcqKey, openDefs, results, paperImages, qPages, showSnippets, mistakeThreshold, onClose, onPick, onSnippet }) {
    ...
    return e(Overlay, { onClose },
      e(Panel, { className: "sfl-panel", title: "Common Mistakes", accent: "red", solid: true, style: { width: "min(820px, 94vw)", maxHeight: "88vh", overflow: "auto" } },
  ...
  function SnippetLightbox({ snippet, onClose }) {
    return e(Overlay, { onClose },
      e("div", { className: "snip-pop" },
        e(Panel, { className: "sfl-panel", title: "Question " + snippet.label + " — worksheet snippet", accent: "blue", solid: true, style: { width: "min(1100px, 96vw)", maxHeight: "92vh", overflow: "auto" } },
  ...
  function SettingsModal({ tweaks, onChange, onClose }) {
    return e(Overlay, { onClose },
      e(Panel, { className: "sfl-panel", title: "Settings", accent: "yellow", solid: true, style: { width: "min(480px, 94vw)" } },
